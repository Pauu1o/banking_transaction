    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    ...
                    <h2 class="mb-2 mt-0 text-4xl font-medium leading-tight dark-text">
                    Update Form 
                    </h2>
                        <div
                        ...
                        <form method="POST" action="{{ route('phonebook.update', ['id' => $phonebook->id]) }}">
                        @csrf <!-- {{ csrf_field() }} -->
                        @method('PUT')
                            ...
                            <div class="relative mb-6" data-te-input-wrapper-init>
                                ...
                                value="{{$phonebook->sender_firstname}}"
